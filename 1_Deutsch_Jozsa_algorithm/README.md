...
4. Applying n Hadamard gates again and we have  $|\psi_3 \rangle = \frac{1}{\sqrt{2^{n}}} \sum_{x=0}^{2^n-1} (-1)^{f(x)} H |x\rangle |-\rangle$. Due to the phase kickback, we ignore the state at the last qubit $|-\rangle$
