...
We hope that the function is either a constant function or a balanced. Constant function return all 0 or all 1 for any input and balanced function return 0 for half of the input and 1 for the other half. Take 2 qubits for example, if our input is 01, the possible output could be $f_1(01) =00$, $f_2(01) =01$, $f_3(01) =10$, $f_4(01) =11$
