...
$|\psi_3 \rangle =  \frac{1}{\sqrt{2^{n}}} \sum_{x=0}^{2^n-1}  |x\rangle | f(x) \rangle =  \frac{1}{\sqrt{2^n}} \sum_{x=0}^{2^n-1}  [ \frac{1}{\sqrt{2^n}} \sum_{j=0}^{2^n-1} (-1)^{x \cdot j} |j\rangle ] | f(x) \rangle =  \sum_{j=0}^{2^n-1} |j \rangle $
