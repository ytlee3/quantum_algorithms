...
As $|k_1k_2k_3...k_n\rangle$  is the product state of $|k_l\rangle$, we can rewrite the equation as: 
...
The whole equation become $\frac{1}{\sqrt{N}} \sum_{k_1=0}^1 \sum_{k_2=0}^1 \sum_{k_3=0}^1 ... \sum_{k_n=0}^1  \otimes_{l=1}^n e^{2 \pi ij k_l 2^{-1}} |k \rangle$
