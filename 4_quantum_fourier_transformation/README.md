...
Take 3 qubits for example, $|j_1j_2j_3 \rangle = (|0\rangle + e^{2\pi i 0.j_3} |1\rangle)(|0\rangle + e^{2\pi i 0.j_2j_3} |1\rangle)(|0\rangle + e^{2\pi i 0.j_1j_2j_3} |1\rangle)$
